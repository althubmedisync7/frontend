...
// The external react-icons imports have been replaced with inline SVG components below

// --- INLINE SVG ICONS ---
// Replaces HiOutlineHome
...
const DoctorSidebar = () => {
   ...
   const handleConfirmLogout = () => {
      ...
      // Implement actual logout logic here (e.g., Firebase signOut, API call)
      // For now, we navigate to the sign-out route
      navigate('/sign-out');
   };
   ...
   return (
      <div className={`w-64 h-screen flex flex-col ${sidebarBlue} ${highlightWhite}`}>
         ...
         <div className="mt-auto p-6 border-t border-gray-700/50">
            <button
               onClick={handleLogoutClick} // Use the function to open the modal
