...
export default function PatientDashboardLayout() {
  const desktopLinkClass = isActive =>
    `flex gap-3 px-4 py-2 rounded-md justify-start group ${
      isActive ? 'bg-[#1E318A] text-white' : 'text-gray-700 hover:bg-gray-100'
    }`;

  const mobileLinkClass = isActive =>
    `flex flex-col items-center justify-center p-2 pt-3 w-full h-full text-center text-xs transition-colors ${
      isActive
